    ...
    public class Program
    {
        ...
        private static void printStats(string i_BinaryNumber1Str, string i_BinaryNumber2Str, string i_BinaryNumber3Str, int i_DecimalNumber1, int i_DecimalNumber2, int i_DecimalNumber3)
        {
            ...
            string statistics = string.Format(
                @"Average number of zeroes: {0}
Average number of ones: {1}
Quantity of numbers divisible by four: {2}
Quantity of descending order numbers: {3}
Quantity of palindrome numbers: {4}", avgOfZeros, avgOfOnes, quantityOfNumbersDivisibleByFour, quantityOfDescendingOrderNumbers, quantityOfPalindromeNumbers);
        ...
        {
            Console.WriteLine("{0}, {1}, {2}", i_BiggestNumber, i_MiddleNumber, i_SmallestNumber);
        }
